...
const CreateWorld = ({ createWorldHandler, progress, formData, titleHandler, created }: CreateWorldProps) => (
  <main style={{ width: "100%", maxWidth: 900, overflow: "hidden" }}>
    ...
    {created ? (
      <Box border="3px solid var(--secondary-color)" borderRadius={2} p={1} sx={{ overflowY: "auto" }}>
        <Result status="success" title="Game world Successfully Created!" />
      </Box>
    ) : (
      <Box border="3px solid var(--secondary-color)" borderRadius={2} px={1} minHeight={300} maxHeight="70vh" sx={{ overflowY: "auto" }}>
