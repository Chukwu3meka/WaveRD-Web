...
const Description = ({ theme, title, description }: DescriptionProps) => (
  <Box>
    ...
    <Alert severity="warning">
      ...
      For testing purposes you can use <strong>`Wave Research-2018`</strong> as Developer's API host and <strong>`Wave Research-APIHUB-2023`</strong>{" "}
      as Developer's API key in your API calls
    </Alert>
  </Box>
);
