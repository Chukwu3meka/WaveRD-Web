...
const Description = ({ title, description }) => (
  <Box py={2}>
    ...
    <Alert severity="warning">
      ...
      For testing purposes you can use <strong>`SoccerMASS-2018`</strong> as Developer's API host and <strong>`SoccerMASS-APIHUB-2023`</strong> as Developer's API key in
      your API calls
    </Alert>
  </Box>
);
