...
import { ComingSoonProps } from "interfaces/components/others/shared.interface";
    ...
    <main className={styles.comingSoon} style={{ minHeight }}>
      ...
      <div>
        ...
        <Typography color="#fff" mt={3}>
          ...
          improvements and updates to the page, so please bear with us while we make it better. Rest assured, we're doing everything we can to get the
          page up and running as soon as possible. We appreciate your patience and understanding while we work through this process. In the meantime,
          feel free to explore other parts of our website. Thank you for your understanding and support!
        </Typography>
      </div>
    </main>
  );
