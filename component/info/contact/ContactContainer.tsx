...
export default () => {
  ...
  const sectionHandler = (value: string) => {
    setUserForm((values: any) => ({ ...values, options: { ...values.options, section: value } }));
  ...
  return <Contact {...{ sectionHandler, contactPreference, categories, submitHandler, commentRef, userForm, onInputChange, contactPrefHandler }} />;
};
